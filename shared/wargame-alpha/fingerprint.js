import { canonicalSerialize } from "./environment-contract.js";
...
function asBytes(value) {
  ...
  throw new TypeError("sha256Hex value must be a string, ArrayBuffer, or ArrayBuffer view");
}

/**
 * Hashes strings as UTF-8 and byte inputs verbatim. ArrayBuffer views are limited
 * to their byteOffset and byteLength rather than hashing their entire backing buffer.
 */
...
export function canonicalSha256(value, label = "value") {
  return `sha256:${sha256Hex(canonicalSerialize(value, label))}`;
}
